...
WebUI.sendKeys(findTestObject('MCV_login_acc'), 'plmcv_lead_linh')

WebUI.delay(3)

WebUI.sendKeys(findTestObject('MCV_login_pass'), 'Pl12345@')

WebUI.delay(3)

WebUI.click(findTestObject('MCV_login_btn_login'))
